...
namespace TestBSManager
{
    ...
    /// </summary>
    [TestClass]
    public class TestSuccessorsForComponentMethod
    {
        public TestSuccessorsForComponentMethod()
        {
            //
        ...
        [TestMethod]
        public void ReturnsSuccessorsCorrectly()
        {

            (new TestAddSuccessorForComponentMethod()).AddsSuccessorSuccessfully();
        }
